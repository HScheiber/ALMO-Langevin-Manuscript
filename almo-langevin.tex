...
(a) $R_{c} = 1.6$ vdWR and $\epsilon_{\text{SCF}} = 10^{-2}$, using fully converged ALMO SCF reference.
(b) $R_{c} = 1.6$ vdWR and fully converged ALMO SCF, using fully converged SCF reference.
(c) $R_{c} = 1.6$ vdWR and $\epsilon_{\text{SCF}} = 10^{-2}$, using fully converged SCF reference.
...
\caption{\label{fig:dynproperties} Calculated dynamic and static properties of water using ALMO DFT with $\epsilon_{\text{SCF}} = 10^{-2}$ and $R_{c} = 1.6$ vdWR.
...
The localization radius was set to $R_{c} = 1.6$ vdWR and $\epsilon_{\text{SCF}} = 10^{-2}$.}
\end{figure}
