...
Calculations were performed with the PBE $\mathrm{E_{XC}}$ functional and the TZV2P basis set on 125 water molecules.}
\end{figure}
...
To test the accuracy of ALMO DFT based MD, we computed dynamical properties for 40 ns MD trajectories using fully converged Kohn-Sham DFT forces and forces computed with our ALMO DFT methods (see fig. %\ref{fig:dynproperties}).
