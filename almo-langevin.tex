...
To test the accuracy of ALMO DFT based MD, we computed dynamical properties for 40 ns MD trajectories using fully converged Kohn-Sham DFT forces and compared with equivalent trajectories using forces computed with ALMO DFT methods (see fig. %\ref{fig:dynproperties}).
