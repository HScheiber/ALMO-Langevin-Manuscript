...
%RZK: On figure 'Wall-clock time' -> 'Wall time', legend - increase font size, decrease the height of the figure(the y-axis label is now shorter). Replace cross symbols on magenta line with another "solid" symbol such as diamon or inverse triangle.
}
\end{figure}
